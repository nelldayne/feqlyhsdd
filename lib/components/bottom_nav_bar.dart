      ...
      child: Padding(
        ...
        child: GNav(
          ...
          tabs: [
            ...
            GButton(icon: CupertinoIcons.skew, text: 'Thửa đất',),
            GButton(icon: CupertinoIcons.book_solid, text: 'Hồ sơ',),
            GButton(icon: CupertinoIcons.profile_circled, text: 'Cá nhân',),
